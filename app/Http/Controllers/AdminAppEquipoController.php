<?php namespace App\Http\Controllers;
	...
	class AdminAppEquipoController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function __construct() {
			...
			$this->form[] = ["label"=>"Estado","name"=>"estregistro","type"=>"select","validation"=>"","width"=>"col-sm-10","dataquery"=>"select id as value,desvalor as label from app_catalogodetalle where id_app_catalogo = 1"];
