<?php namespace App\Http\Controllers;
	...
	class AdminAppEncuentrodetallefastController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function __construct() {
			...
			$this->title_field = "id";
			$this->limit = "20";
			$this->orderby = "id_app_equipo,desc";
			...
			$this->table = "app_encuentrodetallefast";
			...
			$this->form[] = ["label"=>"Cantidad","name"=>"numTotal","type"=>"number","validation"=>"integer","width"=>"col-sm-10"];
			$this->form[] = ["label"=>"Observación","name"=>"desDetalle","type"=>"text","validation"=>"max:255","width"=>"col-sm-10"];
