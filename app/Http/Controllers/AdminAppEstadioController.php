<?php namespace App\Http\Controllers;
	...
	class AdminAppEstadioController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function __construct() {
			...
			$this->table = "app_estadio";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"DesEstadio","name"=>"desestadio"];
			$this->col[] = ["label"=>"DesUbicacion","name"=>"desubicacion"];
			$this->col[] = ["label"=>"DesXY","name"=>"desxy"];
    ...
    //}
	    ...
	    */
	    public function hook_row_index($column_index,&$column_value) {
	    	//Your code here
			if($column_index==4){
				$column_value =	$this->ParseValue($column_value);
			 }
	    }
