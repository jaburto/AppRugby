<?php namespace App\Http\Controllers;
	...
	class AdminAppPlantillaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function __construct() {
			...
			$this->form[] = ["label"=>"Plantilla","name"=>"desPlantilla","type"=>"text","validation"=>"required|min:3|max:255","width"=>"col-sm-10"];
			$this->form[] = ["label"=>"Periodo","name"=>"numPeriodo","type"=>"number","validation"=>"required|integer|min:0","width"=>"col-sm-10"];
